...
import 'package:flutter_application_1/helpers/log_helper.dart';
  ...
  test(
    ...
    () async {
      ...
      try {
        ...
        expect(dotenv.env['MONGODB_URI']!.isNotEmpty, true); // Ensure URI is not empty

        await LogHelper.writeLog(
          "SUCCESS: Terhubung ke MongoDB Atlas", // Changed to match required output
          source: sourceFile,
          level: 2, // INFO (Hijau)
        );
      } catch (e) {
